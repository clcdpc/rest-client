...
public class JsonNetDeserializerTests
{
    ...
    public void Deserialize_ValidJson_ReturnsDeserializedObject()
    {
        ...
        const string json = "{\"Id\": 1, \"Name\": \"Test\", \"IsActive\": true}";
    ...
    [TestMethod]
    public void Deserialize_MalformedJson_ThrowsJsonExceptionDerivedException()
    {
        var deserializer = new JsonNetDeserializer();
        ...
        try
        {
            deserializer.Deserialize<TestModel>("{\"Id\":1");
        }
