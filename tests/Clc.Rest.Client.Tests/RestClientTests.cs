...
public class RestClientTests
{
    ...
    [TestMethod]
    public async Task PostForm_Uses_FormUrlEncodedContent()
    {
        var handler = new FakeHttpMessageHandler(_ => JsonResponse("{}"));
        var client = CreateClient(handler);
    ...
    [TestMethod]
    public async Task Post_With_Body_And_QueryParameters_Does_Not_Overwrite_Body()
    {
        var handler = new FakeHttpMessageHandler(_ => JsonResponse("{}"));
        var client = CreateClient(handler);
    ...
    [TestMethod]
    public async Task Get_With_QueryParameters_Appends_Query_String()
    {
        var handler = new FakeHttpMessageHandler(_ => JsonResponse("{}"));
        var client = CreateClient(handler);
    ...
    [TestMethod]
    public async Task ExecuteAsync_Request_With_Absolute_Url_Sends_Absolute_Url_When_BaseUrl_Is_Set()
    {
        var handler = new FakeHttpMessageHandler(_ => JsonResponse("{}"));
        var client = CreateClient(handler);
        client.BaseUrl = "https://api.example.com";
    ...
    [TestMethod]
    public async Task ExecuteAsync_Request_With_Method_And_Absolute_Url_Sends_Absolute_Url_When_BaseUrl_And_PathPrefix_Are_Set()
    {
        var handler = new FakeHttpMessageHandler(_ => JsonResponse("{}"));
        var client = CreateClient(handler);
        client.BaseUrl = "https://api.example.com";
