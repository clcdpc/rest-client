...
public class RestClientTests
{
    ...
    public void BuildUrl_Returns_Absolute_Path_Unchanged_When_BaseUrl_Is_Set()
    {
        ...
        var builtUrl = client.BuildUrl(request);

        Assert.AreEqual("https://other.example.com/items", builtUrl);
    }
    ...
    public void BuildUrl_Returns_Absolute_Path_Unchanged_When_PathPrefix_Is_Set()
    {
        ...
        Assert.AreEqual("https://other.example.com/items?existing=true", builtUrl);
    }
