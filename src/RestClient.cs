...
namespace Clc.Rest
{
    public abstract class RestClient : IRestClient
    {
        ...
        public IRestResponse<T> Get<T>(string url, Dictionary<string, string> parameters = null) => Execute<T>(new RestRequest(HttpMethod.Get, url, parameters: parameters));

        public IRestResponse<T> Post<T>(string url, Dictionary<string, string> parameters = null, object body = null) => Execute<T>(new RestRequest(HttpMethod.Post, url, body, parameters));

        public IRestResponse<T> Patch<T>(string url, Dictionary<string, string> parameters = null, object body = null) => Execute<T>(new RestRequest(new HttpMethod("PATCH"), url, body, parameters));

        public IRestResponse<T> Put<T>(string url, Dictionary<string, string> parameters = null, object body = null) => Execute<T>(new RestRequest(HttpMethod.Put, url, body, parameters));

        public IRestResponse<T> Delete<T>(string url, Dictionary<string, string> parameters = null, object body = null) => Execute<T>(new RestRequest(HttpMethod.Delete, url, body, parameters));

        public IRestResponse<T> Execute<T>(HttpMethod method, string url, Dictionary<string, string> parameters = null, object body = null) => Execute<T>(new RestRequest(method, url, body, parameters));

        public IRestResponse<T> Execute<T>(string url, HttpMethod method = null, Dictionary<string, string> parameters = null, object body = null) => Execute<T>(new RestRequest(method ?? HttpMethod.Get, url, body, parameters));
