...
For async APIs in 3.0, execution is async-only; do not add synchronous Execute<T> wrappers or other sync-over-async convenience APIs unless a task explicitly requests them.
