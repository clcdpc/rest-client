...
The v3 alpha library targets `.NET 8` (`net8.0`) only.

Do not introduce APIs that require a newer target unless one of these is true:
...
- Pass tokens to content reads where target framework support exists.
